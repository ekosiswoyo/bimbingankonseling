...
if(isset($_POST['chatk'])){
  ...
  if($chat != ''){
  $sql = "INSERT INTO chat (id_chat, nisn, nip, chat, stat_chat, tgl) VALUES ('','$nisn','$nip','$chat','2','$tgl')";
...
ob_start();
    ...
    ?>
    <?php if($datachat['stat_chat'] == 2){ ?>
     
      <!-- Message to the right -->
      <div class="direct-chat-msg right">
      <div class="direct-chat-infos clearfix">
        <span class="direct-chat-name float-right"><?php echo $datachat['nm_guru']; ?></span>
    ...
    <div class="direct-chat-msg">
      <div class="direct-chat-infos clearfix">
        <span class="direct-chat-name float-left"><?php echo $datachat['nm_siswa']; ?></span>
