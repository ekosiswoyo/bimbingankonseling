            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  $no =1;
                  if($level == "Admin"){
                  $query = mysqli_query($connect, "SELECT * FROM laporan a, tb_siswa b, tb_kelas c, tb_guru d where a.nisn = b.nisn and a.nip=d.nip and c.id_kls=b.id_kls ORDER BY a.nip DESC");
                }else{
                ...
                <tr>
                  ...
                  <td><?php $date=strtotime($data['tgl_lap']); echo date ('d-m-Y h:m:s',$date);?></td>
