              ...
              <form role="form" method="post">
                <div class="card-body">
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nisn" id="exampleInputEmail1" placeholder="NISN" required>
                  </div>
...
if(isset($_POST['insert'])){
    ...
    $id_kls = $_POST['id_kls'];
    $ceknisn =mysqli_num_rows($connect, "SELECT * FROM tb_siswa WHERE nisn=$nisn");
      if($ceknisn > 0){
        echo "<script>window.alert('NISN Sudah Ada')</script>";
  
        echo "<script>window.location='siswa.php';</script>";
      }else{
        echo "<script>document.location='addsis.php?nisn=$nisn';</script>";
