...
$nisn = $_GET['nisn'];
$user = mysqli_query($connect, "SELECT * FROM tb_siswa a, tb_kelas b WHERE a.nisn=$nisn and a.id_kls=b.id_kls");
$siswa = mysqli_fetch_array($user);
// $id = $_GET['id_sekolah'];
              ...
              <form role="form" method="POST" action="">
                <div class="card-body">
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nisn" id="exampleInputEmail1" placeholder="nisn" value="<?php echo $siswa['nisn']; ?>" readonly>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Siswa</label>
                    <input type="text" class="form-control" name="nm_siswa" id="exampleInputEmail1" placeholder="Nama Siswa" value="<?php echo $siswa['nm_siswa']; ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                        ...
                        <select class="form-control" name="id_kls">
                          <option value="<?php echo $siswa['id_kls']; ?>"><?php echo $siswa['nm_kls']; ?></option>
                          <?php
...
if(isset($_POST['update'])){
    ...
    if($password == NULL){
      $sql = "update tb_siswa set nm_siswa='$nm_siswa', id_kls='$id_kls' where nisn='$nisn'";
      $query = mysqli_query($connect, $sql);
      echo "<script>window.location='siswa.php';</script>";
    }else{
      $abc =mysqli_query($connect, "SELECT * FROM tb_siswa WHERE nisn=$nisn LIMIT 1");
      while ($datar = mysqli_fetch_array($abc)) {
      $abc_lama = $datar['password'];

        if($pass_lama == $abc_lama){
       $sql = "update tb_siswa set nm_siswa='$nm_siswa', id_kls='$id_kls', password='$password' where nisn='$nisn'";
