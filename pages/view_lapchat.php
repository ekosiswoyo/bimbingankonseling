            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  $no =1;
                  $query = mysqli_query($connect, "SELECT * FROM chat a, tb_guru b, user_siswa c, tb_kelas d where a.nip = b.nip and a.nisn=c.nisn and c.id_kls=d.id_kls and a.stat_chat=1 ORDER BY a.id_chat DESC");
              ...
              <form role="form" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="jwb_guru" class="form-control" disabled><?php echo $datchat['jwb_guru'];?></textarea>
