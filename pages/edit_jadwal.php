...
$jadwal = mysqli_query($connect, "SELECT * FROM jdwl_konseling WHERE id_jadwal=$id_jadwal");
$datas = mysqli_fetch_array($jadwal);
?>
              ...
              <form role="form" method="post">
                <div class="card-body">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="jam_mulai" id="exampleInputEmail1" placeholder="Jam Mulai" value="<?php echo $datas['jam_mulai']; ?>">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Jam Selesai</label>
                    <input type="text" class="form-control" name="jam_selesai" id="exampleInputEmail1" placeholder="Jam Selesai" value="<?php echo $datas['jam_selesai']; ?>">
                  </div>
...
if(isset($_POST['insert'])){
    ...
    $nip = $_POST['nip'];
    $sql = "update jdwl_konseling set hari='$hari',jam_mulai='$jam_mulai', jam_selesai='$jam_selesai', nip='$nip' where nip='$nip'";
